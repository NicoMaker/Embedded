...
FINAL_IMAGE=${DISTDIR}/Esame_intermedio.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Esame_intermedio.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
